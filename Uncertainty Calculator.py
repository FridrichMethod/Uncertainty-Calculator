...
def latex_unit(expr):
    return latex(expr, fold_short_frac=True)
...
equation_right = simplify(equation[1])
...
\\begin{aligned}''')
        ...
        if result_unit == 1:
            ...
            print(f'{result_mu}\\ {latex_unit(result_unit)}' + '\\\\\n\\\\')
        ...
        if result_unit == 1:
            ...
            print(f'{result_sigma}\\ {latex_unit(result_unit)}' + '\\\\\n\\\\')
        ...
        if result_unit == 1:
            ...
            print(f'{equation_left}&=\\left ({result_mu} \\pm {result_sigma} \\right )\\ {latex_unit(result_unit)}')
        print('''\\end{aligned}
\\end{equation}''')
